...
public class AppUtils {
    ...
    public static boolean ShowRaceFragment=false;
    public static int race_id=-1;
    public static boolean ShowShoeActivity=false;
    public static String StrRaceShoesName="";
    ...
    public class LocationConstants {
        ...
        public static final String PACKAGE_NAME = "com.technerds.racelogger";
