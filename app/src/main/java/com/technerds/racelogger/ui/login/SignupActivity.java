...
import com.technerds.racelogger.viewModels.authentication.SignupViewModel;
...
public class SignupActivity extends AppCompatActivity implements OnCompressListener, LocationListener, OnStatePickerListener, OnCountryPickerListener, OnCityPickerListener {
    ...
    public void setupViewModels() {
        ...
        signupObserveViewModel(signupViewModel);
    ...
    public void SignUpClicked(View view) {
        ...
        String confirm_password = binding.editTextConfirmPassword.getText().toString();
        ...
        if(confirm_password != null && (!confirm_password.equalsIgnoreCase(""))  && confirm_password != ""){
        ...
        if(allCorrect && locCorrect) {
           // Snackbar.make(view, "All Correct", Snackbar.LENGTH_SHORT).show();
            ...
            SignUpSendModel model = new SignUpSendModel();
            ...
            model.setPassword_confirmation(confirm_password);
            model.setFcm_token(fcm_token);
            model.setTime_zone(timeZoneS);
            model.setStreet_address(streetAddress);
            model.setAddress(streetAddress+", "+city+", "+state+", "+country);
            model.setCity(city);
    ...
    private void signupObserveViewModel(final SignupViewModel viewModel) {
        ...
        viewModel.getResponse().observe(this, apiResponse -> {
            ...
            if (apiResponse != null) {
                if (apiResponse.status == Status.SUCCESS) {
                    ...
                    Log.wtf("-this", "SignUp API Response : " + apiResponse.data);
                    ...
                    try {
                        ...
                        if (responseBodyResponse.body() != null) {
                            ...
                            Log.wtf("retrofit_", "SignUp response body: " + json);
                            ...
                            if (status == 1) {
                                ...
                                Log.wtf("-this", "SignUp Token : " + model.getData().getToken());
                    ...
                    Log.wtf("-this", "SignUp API Response : " + apiResponse.error.getMessage());
                    binding.progressLayout.setVisibility(View.GONE);
                }
            }
        });
