...
import com.technerds.racelogger.databinding.ActivityEditRaceBinding;
...
import com.technerds.racelogger.viewModels.UpdateRaceViewModel;
...
public class EditRaceActivity extends AppCompatActivity implements OnCompressListener, OnStatePickerListener, OnCountryPickerListener, OnCityPickerListener {
    ...
    ActivityEditRaceBinding binding;
    View view;
    ...
    UpdateRaceViewModel UpdateRaceViewModel;
...
//        getWindow().clearFlags(WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS);
        ...
        binding = ActivityEditRaceBinding.inflate(getLayoutInflater());
    ...
    public void setupViewModels() {
        ...
        UpdateRaceViewModel = new ViewModelProvider(this).get(UpdateRaceViewModel.class);
        updateRaceObserveViewModel(UpdateRaceViewModel);
    ...
    private void init() {
       ...
       /* if(AppUtils.all_img_list.size()>0){
            Toast.makeText(this, String.valueOf(AppUtils.all_img_list.size()), Toast.LENGTH_SHORT).show();

            for (int i=0;i<AppUtils.all_img_list.size();i++){
                PicModel picModel = new PicModel();
                picModel.setName("fileName");
                picModel.setURL(AppUtils.all_img_list.get(i));
    ...
    void setValues() {
        ...
        if (StringChecker.checkString(raceDetailModel.getRaceData().getRace().getRaceName()))
            binding.editTextRaceName.setText("" + raceDetailModel.getRaceData().getRace().getRaceName());

        if (StringChecker.checkString(raceDetailModel.getRaceData().getRace().getParkName()))
            binding.editTextParkName.setText("" + raceDetailModel.getRaceData().getRace().getParkName());

        if (StringChecker.checkString(raceDetailModel.getRaceData().getDate())) {
            binding.textViewDateTime.setText("" + raceDetailModel.getRaceData().getDate());
            raceDate = raceDetailModel.getRaceData().getDate();
        }

        if (StringChecker.checkString(raceDetailModel.getRaceData().getRace().getCity()))
            binding.editTextCity.setText("" + raceDetailModel.getRaceData().getRace().getCity());

        if (StringChecker.checkString(raceDetailModel.getRaceData().getRace().getState()))
            binding.editTextState.setText("" + raceDetailModel.getRaceData().getRace().getState());

        if (StringChecker.checkString(raceDetailModel.getRaceData().getRace().getCountry()))
            binding.editTextCountry.setText("" + raceDetailModel.getRaceData().getRace().getCountry());

        if (StringChecker.checkString(raceDetailModel.getRaceData().getRace().getZipCode()))
            binding.editTextZipCode.setText("" + raceDetailModel.getRaceData().getRace().getZipCode());

        if (StringChecker.checkString(raceDetailModel.getRaceData().getRace().getUserDistance()))
            binding.editTextDistance.setText("" + raceDetailModel.getRaceData().getRace().getUserDistance() + "" + raceDetailModel.getRaceData().getRace().getUnit());

        if (StringChecker.checkString(raceDetailModel.getRaceData().getRace().getCourseType()))
            binding.editTextCourseType.setText("" + raceDetailModel.getRaceData().getRace().getCourseType());
        ...
        if (StringChecker.checkString(raceDetailModel.getRaceData().getRace().getTemperature())) {
            ...
            temperature = raceDetailModel.getRaceData().getRace().getTemperature();
            ...
            temperatureUnit = raceDetailModel.getRaceData().getRace().getTemperatureUnit();
        ...
        if (StringChecker.checkString(raceDetailModel.getRaceData().getRace().getWeather()))
            binding.editTextWeather.setText("" + raceDetailModel.getRaceData().getRace().getWeather());
        ...
        if (StringChecker.checkString(raceDetailModel.getRaceData().getFinishPlace()))
            binding.editTextFinishPlace.setText("" + raceDetailModel.getRaceData().getFinishPlace());

        if (StringChecker.checkString(raceDetailModel.getRaceData().getFinishGroupPlace()))
            binding.editTextGroupFinishPlace.setText("" + raceDetailModel.getRaceData().getFinishGroupPlace());
        ...
        if ((!raceDetailModel.getRaceData().getHour().equalsIgnoreCase("0"))
            ...
            binding.editTextRunTimeHour.setText(raceDetailModel.getRaceData().getHour());
            binding.editTextRunTimeMinute.setText(raceDetailModel.getRaceData().getMinute());
            binding.editTextRunTimeSecond.setText(raceDetailModel.getRaceData().getSecond());

        }


        if (StringChecker.checkString(raceDetailModel.getRaceData().getRace().getTotalRunners()))
            binding.editTextTotalRunners.setText("" + raceDetailModel.getRaceData().getRace().getTotalRunners());

        if (StringChecker.checkString(raceDetailModel.getRaceData().getAgeGroupRunner()))
            binding.editTextRunnersInMyAgeGroup.setText("" + raceDetailModel.getRaceData().getAgeGroupRunner());

        if (StringChecker.checkString(raceDetailModel.getRaceData().getRace().getMaleRunners()))
            binding.editTextMaleRunners.setText("" + raceDetailModel.getRaceData().getRace().getMaleRunners());

        if (StringChecker.checkString(raceDetailModel.getRaceData().getRace().getFemaleRunners()))
            binding.editTextFemaleRunners.setText("" + raceDetailModel.getRaceData().getRace().getFemaleRunners());

        String ageGroup = raceDetailModel.getRaceData().getAgeGroup();
        if (StringChecker.checkString(ageGroup)) {
            binding.spinnerAgeGroup.setText("" + AgeGroups.getAgeGroupFromId(Integer.parseInt(ageGroup)));
        }

        if (StringChecker.checkString(raceDetailModel.getRaceData().getRace().getStreetAddress()))
            binding.editTextStreet.setText("" + raceDetailModel.getRaceData().getRace().getStreetAddress());
        ...
        if (raceDetailModel.getRaceData().getUserGallery() != null) {
            if (raceDetailModel.getRaceData().getUserGallery().size() > 0) {
                if (raceDetailModel.getRaceData().getUserGallery().size() > 0) {
                    for (int m = 0; m < raceDetailModel.getRaceData().getUserGallery().size(); m++) {
                        PicModel picModel = new PicModel();
                        picModel.setName(raceDetailModel.getRaceData().getUserGallery().get(m).getImage());
                        picModel.setURL(raceDetailModel.getRaceData().getUserGallery().get(m).getUrl());
                        picList.add(picModel);
                     //   Toast.makeText(this, String.valueOf(raceDetailModel.getRaceData().getUserGallery().get(m).getImage()), Toast.LENGTH_SHORT).show();
                    }
                    //Toast.makeText(this, String.valueOf("Gallery size:"+raceDetailModel.getRaceData().getUserGallery().size()), Toast.LENGTH_SHORT).show();
        ...
        if (raceDetailModel.getRaceData().getRace() != null) {
            if (raceDetailModel.getRaceData().getRace().getEnjoymentRating() != null) {
                String enj = raceDetailModel.getRaceData().getRace().getEnjoymentRating().getRating();
            ...
            if (raceDetailModel.getRaceData().getRace().getToughnessRating() != null) {
                String enj = raceDetailModel.getRaceData().getRace().getToughnessRating().getRating();
                if (StringChecker.checkString(enj)) {
                    float enjF = Float.parseFloat(enj);
            ...
            if (raceDetailModel.getRaceData().getRace().getFeelMeterRating() != null) {
                String enj = raceDetailModel.getRaceData().getRace().getFeelMeterRating().getRating();
                if (StringChecker.checkString(enj)) {
                    float enjF = Float.parseFloat(enj);
        ...
        if (raceDetailModel.getRaceData().getUserShoe() != null) {
            String enj = raceDetailModel.getRaceData().getUserShoe().getShoeProfile().getComfortRating();
            if (StringChecker.checkString(enj)) {
                float enjF = Float.parseFloat(enj);
                binding.ratingBarFeelMeter.setRating(enjF);
            }
    ...
    private void setPicAdapter() {
        //   Toast.makeText(this, "set adapter method:"+picList.size(), Toast.LENGTH_SHORT).show();
    ...
    private void setShoeProfile() {
        if (getShoeProfiles.getData() != null) {
            if (getShoeProfiles.getData().size() > 0) {
                ...
                binding.spinnerShoeProfile.setHint(AppUtils.StrRaceShoesName);
                binding.spinnerShoeProfile.setHintColor(getResources().getColor(R.color.home_text_color));
                    ...
                    public void onItemSelected(MaterialSpinner view, int position, long id, String item) {
                        if (item != null) {
                            ...
                            if (item.equalsIgnoreCase("Add Shoe profile")) {
                                Intent intent = new Intent(EditRaceActivity.this, AddShoeActivity.class);
...
//        }
        ...
        UpdateRaceSendModel updateRaceSendModel = new UpdateRaceSendModel();

        updateRaceSendModel.setToken(token);
        updateRaceSendModel.setId(raceDetailModel.getRaceData().getId());
        updateRaceSendModel.setRaceName(race_name);
        updateRaceSendModel.setPark_name(park_name);
        updateRaceSendModel.setStreet_address(street_address);
        updateRaceSendModel.setCity(city);
        updateRaceSendModel.setState(state);
        updateRaceSendModel.setCountry(country);
        updateRaceSendModel.setZip_code(zip_code);
        updateRaceSendModel.setDistance(distance);
        updateRaceSendModel.setUnit(unit);
        updateRaceSendModel.setCourse_type(courseType);
        updateRaceSendModel.setTemperature(temperature);
        updateRaceSendModel.setTemperature_unit(temperatureUnit);
        updateRaceSendModel.setWeather(weather);
        if (total_runners != null && (!total_runners.equalsIgnoreCase("")) && total_runners.length() > 0) {
            updateRaceSendModel.setTotal_runners(Integer.parseInt(total_runners));
        }

        if (male_runners != null && (!male_runners.equalsIgnoreCase("")) && male_runners.length() > 0) {
            updateRaceSendModel.setMale_runners(Integer.parseInt(male_runners));
        }

        if (female_runners != null && (!female_runners.equalsIgnoreCase("")) && female_runners.length() > 0) {
            updateRaceSendModel.setFemale_runners(Integer.parseInt(female_runners));
        }
        ...
        updateRaceSendModel.setEnjoyment_rating(enjoyment_rating);
        updateRaceSendModel.setFeel_meter_rating(feel_meter_rating);
        updateRaceSendModel.setToughness_rating(toughness_rating);
        updateRaceSendModel.setUser_race(userRaceModel);
        ...
        if (shoeProfileID > 0) {
            updateRaceSendModel.setShoes_profile_id(shoeProfileID);
        }
        updateRaceSendModel.setRace_terrain(terrainSendList);
        ...
        updateRaceSendModel.setUserGallery(picNameList);

        if (allCorrect) {
            binding.progressLayout.setVisibility(View.VISIBLE);
            UpdateRaceViewModel.updateRace(updateRaceSendModel);
        } else {
    ...
    private void updateRaceObserveViewModel(final UpdateRaceViewModel viewModel) {
        // Observe project data
        viewModel.getResponse().observe(this, apiResponse -> {
                        ...
                        if (responseBodyResponse.body() != null) {
                            ...
                            if (status == 1) {
                               ...
                               /* Intent intent = new Intent();
                                ...
                                Intent Send = new Intent(EditRaceActivity.this, RaceDetailActivity.class);
                                startActivity(Send);
                                finish();
...
//            }
    ...
    public void openCameraClicked(View view) {
        binding.cameraLayout.setVisibility(View.GONE);
        Intent intent = new Intent(EditRaceActivity.this, CameraActivity.class);
