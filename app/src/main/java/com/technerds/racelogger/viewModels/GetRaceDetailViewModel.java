...
public class GetRaceDetailViewModel extends AndroidViewModel {
    private MutableLiveData<ApiResponse> apiResponseMutableLiveData;
    private final CompositeDisposable mDisposables = new CompositeDisposable();

    public GetRaceDetailViewModel(@NonNull Application application) {
        super(application);
    }
    ...
    public void getRaceDetail(String token, int id) {
        mDisposables.add(NetworkRepository.getInstance().getRaceDetail(token, id)
