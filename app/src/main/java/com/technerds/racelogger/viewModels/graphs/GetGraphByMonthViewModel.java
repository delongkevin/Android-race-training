...
public class GetGraphByMonthViewModel extends AndroidViewModel {
    private MutableLiveData<ApiResponse> apiResponseMutableLiveData;
    private final CompositeDisposable mDisposables = new CompositeDisposable();

    public GetGraphByMonthViewModel(@NonNull Application application) {
        super(application);
    }
    ...
    public void getGraphByMonth(String token, int year) {
        mDisposables.add(NetworkRepository.getInstance().getGraphByMonth(token, year)
