...
public class GetSortedRaceListingViewModel extends AndroidViewModel {
    private MutableLiveData<ApiResponse> apiResponseMutableLiveData;
    private final CompositeDisposable mDisposables = new CompositeDisposable();

    public GetSortedRaceListingViewModel(@NonNull Application application) {
        super(application);
    }
    ...
    public void getSortedRaceListing(SortedRaceListingSendModel model) {
        mDisposables.add(NetworkRepository.getInstance().getSortedRaceListing(model)
