...
public class GetGraphFirstPlacesViewModel extends AndroidViewModel {
    private MutableLiveData<ApiResponse> apiResponseMutableLiveData;
    private final CompositeDisposable mDisposables = new CompositeDisposable();

    public GetGraphFirstPlacesViewModel(@NonNull Application application) {
        super(application);
    }
    ...
    public void getGraphFirstPlaces(String token) {
        mDisposables.add(NetworkRepository.getInstance().getGraphFirstPlaces(token)
