...
public class GetGraphByWeekViewModel extends AndroidViewModel {
    private MutableLiveData<ApiResponse> apiResponseMutableLiveData;
    private final CompositeDisposable mDisposables = new CompositeDisposable();

    public GetGraphByWeekViewModel(@NonNull Application application) {
        super(application);
    }
    ...
    public void getGraphByWeek(String token, int year, int month) {
        mDisposables.add(NetworkRepository.getInstance().getGraphByWeek(token, year, month)
