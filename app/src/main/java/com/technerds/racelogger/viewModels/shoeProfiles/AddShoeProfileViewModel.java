package com.technerds.racelogger.viewModels.shoeProfiles;
...
public class AddShoeProfileViewModel extends AndroidViewModel {
    private MutableLiveData<ApiResponse> apiResponseMutableLiveData;
    private final CompositeDisposable mDisposables = new CompositeDisposable();

    public AddShoeProfileViewModel(@NonNull Application application) {
        super(application);
    }
    ...
    public void addShoeProfile(AddShoeSendModel model) {
        mDisposables.add(NetworkRepository.getInstance().addShoeProfile(model)
