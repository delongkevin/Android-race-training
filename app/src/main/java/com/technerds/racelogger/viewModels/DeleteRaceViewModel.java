...
public class DeleteRaceViewModel extends AndroidViewModel {
    private MutableLiveData<ApiResponse> apiResponseMutableLiveData;
    private final CompositeDisposable mDisposables = new CompositeDisposable();

    public DeleteRaceViewModel(@NonNull Application application) {
        super(application);
    }
    ...
    public void deleteRaceRecord(String token, int id) {
        mDisposables.add(NetworkRepository.getInstance().deleteRaceRecord(token, id)
