...
public class AddRaceViewModel extends AndroidViewModel {
    private MutableLiveData<ApiResponse> apiResponseMutableLiveData;
    private final CompositeDisposable mDisposables = new CompositeDisposable();

    public AddRaceViewModel(@NonNull Application application) {
        super(application);
    }
    ...
    public void addRace(AddRaceSendModel model) {
        mDisposables.add(NetworkRepository.getInstance().addRace(model)
