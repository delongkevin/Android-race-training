...
public class GetRunListingsViewModel extends AndroidViewModel {
    private MutableLiveData<ApiResponse> apiResponseMutableLiveData;
    private final CompositeDisposable mDisposables = new CompositeDisposable();

    public GetRunListingsViewModel(@NonNull Application application) {
        super(application);
    }
    ...
    public void getRunListing(String token, int page) {
        mDisposables.add(NetworkRepository.getInstance().getRunListing(token, page)
