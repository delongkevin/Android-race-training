...
public class GetUserDashboardViewModel extends AndroidViewModel {
    private MutableLiveData<ApiResponse> apiResponseMutableLiveData;
    private final CompositeDisposable mDisposables = new CompositeDisposable();

    public GetUserDashboardViewModel(@NonNull Application application) {
        super(application);
    }
    ...
    public void getUserDashboard(String token) {
        mDisposables.add(NetworkRepository.getInstance().getUserDashboard(token)
