...
public class GetGraphByYearViewModel extends AndroidViewModel {
    private MutableLiveData<ApiResponse> apiResponseMutableLiveData;
    private final CompositeDisposable mDisposables = new CompositeDisposable();

    public GetGraphByYearViewModel(@NonNull Application application) {
        super(application);
    }
    ...
    public void getGraphByYear(String token) {
        mDisposables.add(NetworkRepository.getInstance().getGraphByYear(token)
