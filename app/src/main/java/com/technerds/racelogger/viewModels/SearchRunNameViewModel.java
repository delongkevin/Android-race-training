...
public class SearchRunNameViewModel extends AndroidViewModel {
    private MutableLiveData<ApiResponse> apiResponseMutableLiveData;
    private final CompositeDisposable mDisposables = new CompositeDisposable();

    public SearchRunNameViewModel(@NonNull Application application) {
        super(application);
    }
    ...
    public void searchRunName(String token) {
        mDisposables.add(NetworkRepository.getInstance().searchRunName(token)
