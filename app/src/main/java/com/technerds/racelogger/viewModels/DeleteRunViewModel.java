...
public class DeleteRunViewModel extends AndroidViewModel {
    private MutableLiveData<ApiResponse> apiResponseMutableLiveData;
    private final CompositeDisposable mDisposables = new CompositeDisposable();

    public DeleteRunViewModel(@NonNull Application application) {
        super(application);
    }
    ...
    public void deleteRunRecord(String token, int id) {
        mDisposables.add(NetworkRepository.getInstance().deleteRunRecord(token, id)
