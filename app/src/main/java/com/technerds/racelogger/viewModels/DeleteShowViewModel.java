...
public class DeleteShowViewModel extends AndroidViewModel {
    private MutableLiveData<ApiResponse> apiResponseMutableLiveData;
    private final CompositeDisposable mDisposables = new CompositeDisposable();

    public DeleteShowViewModel(@NonNull Application application) {
        super(application);
    }
    ...
    public void deleteShowRecord(String token, int id) {
        mDisposables.add(NetworkRepository.getInstance().deleteShowRecord(token, id)
