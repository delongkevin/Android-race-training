...
public class GetRunDetailViewModel extends AndroidViewModel {
    private MutableLiveData<ApiResponse> apiResponseMutableLiveData;
    private final CompositeDisposable mDisposables = new CompositeDisposable();

    public GetRunDetailViewModel(@NonNull Application application) {
        super(application);
    }
    ...
    public void getRunDetail(String token, int id) {
        mDisposables.add(NetworkRepository.getInstance().getRunDetail(token, id)
