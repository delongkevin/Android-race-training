...
public class ForgotPassowrdViewModel extends AndroidViewModel {
    private MutableLiveData<ApiResponse> apiResponseMutableLiveData;
    private final CompositeDisposable mDisposables = new CompositeDisposable();
    
    public ForgotPassowrdViewModel(@NonNull Application application) {
        super(application);
    }
    ...
    public void forgotPassword( String email) {
        mDisposables.add(NetworkRepository.getInstance().forgotPassword(email)
