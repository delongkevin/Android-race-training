...
public class GetDropDownViewModel extends AndroidViewModel {
    private MutableLiveData<ApiResponse> apiResponseMutableLiveData;
    private final CompositeDisposable mDisposables = new CompositeDisposable();

    public GetDropDownViewModel(@NonNull Application application) {
        super(application);
    }
    ...
    public void getDropDown() {
        mDisposables.add(NetworkRepository.getInstance().getDropDown()
