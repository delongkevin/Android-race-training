...
public class GetShoeProfilesViewModel extends AndroidViewModel {
    private MutableLiveData<ApiResponse> apiResponseMutableLiveData;
    private final CompositeDisposable mDisposables = new CompositeDisposable();

    public GetShoeProfilesViewModel(@NonNull Application application) {
        super(application);
    }
    ...
    public void getShoeProfiles(String token) {
        mDisposables.add(NetworkRepository.getInstance().getShoeProfiles(token)
