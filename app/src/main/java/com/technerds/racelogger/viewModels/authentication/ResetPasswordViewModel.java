package com.technerds.racelogger.viewModels.authentication;
...
public class ResetPasswordViewModel extends AndroidViewModel {
    ...
    public void resetPassword(String forget_token, String password, String confirmation_password) {
        mDisposables.add(NetworkRepository.getInstance().resetPassword(forget_token, password, confirmation_password)
