...
public class UpdateRaceViewModel extends AndroidViewModel {
    private MutableLiveData<ApiResponse> apiResponseMutableLiveData;
    private final CompositeDisposable mDisposables = new CompositeDisposable();

    public UpdateRaceViewModel(@NonNull Application application) {
        super(application);
    }
    ...
    public void updateRace(UpdateRaceSendModel model) {
        mDisposables.add(NetworkRepository.getInstance().updateRace(model)
